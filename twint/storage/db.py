...
def tweets(conn, Tweet, config):
    try:
        ...
        entry = (Tweet.id,
                    ...
                    Tweet.name,
                    Tweet.link,
                    ",".join('%s' %id for id in Tweet.mentions),
                    ",".join('%s' %id for id in Tweet.hashtags),
                    ",".join('%s' %id for id in Tweet.cashtags),
                    ",".join('%s' %id for id in Tweet.urls),
                    ",".join('%s' %id for id in Tweet.photos),
                    Tweet.thumbnail,
                    Tweet.quote_url,
                    Tweet.video,
                    Tweet.geo,
